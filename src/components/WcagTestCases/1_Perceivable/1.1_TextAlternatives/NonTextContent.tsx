...
export const NonTextContent = (nonTextContentProps: NonTextContentProps) => {
  document.title = nonTextContentProps.pageTitle;
  return (
    <>
      <Header pageTitle={nonTextContentProps.pageTitle} />
        ...
        <section className={"middle-section"}>
          ...
          >
            ...
            <p>
              ...
              are put into the 'text alternative' location on images or
              pictures.
            </p>
            ...
            <p>
              ...
              function of the non-text content such as "picture 1", "picture 2"
              or "0001", "0002" or "Intro#1", "Intro#2".
            </p>
          ...
          >
            <p>
              This describes a failure condition for text alternatives for
              images that should be ignored by assistive technology (AT). If an
              image has the attribute role="presentation", it will be ignored by
              AT.
            </p>
            <p>
              However, if it does not have role="presentation", and if there is
              no alt attribute at all assistive technologies are not able to
              ignore the image. For decorative images which need to be ignored
              by AT, either role="presentation" must be used or the alt
              attribute must be provided and have a null value (i.e., alt="") to
          ...
          >
            <p>
              An image is used to create a blank space between content, where
              the spacing itself is not meaningful to the content.
              <img
                alt="spacer"
                height={"1px"}
                src={SPACER}
                width={"180px"}
              />{" "}
              The image has an alt text value of "spacer". This image fails the
          ...
          >
            <p>
              ...
              the characters are implemented with character entities, but the
              word will still not be processed meaningfully, and a text
          ...
          >
            <p>
              The following ASCII art chart lacks a text alternative and
              therefore does not meet Success Criterion 1.1.1.
            </p>
            <pre>
              {`
      ...
      Flash frequency (Hz)
          ...
          >
            <div className={"warning-icon"}>
              Taking too much of your pension money in early retirement could
              mean you don't have enough for later.
            </div>
          </GuidelineError>
          ...
          >
            <p>
              ...
              attribute does not include this information, only a partial "25%
              off sale"
            </p>
