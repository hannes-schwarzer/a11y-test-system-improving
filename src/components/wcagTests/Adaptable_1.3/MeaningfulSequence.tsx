...
export const MeaningfulSequence = () => {
  return (
    <>
      <TestCase
        testCaseTitle={
        ...
        testCategory={"1.3.2 Meaningful Sequence"}
        testCaseNumber={1}
        guideline={"1.3.2"}
        linkToGuideline={
...
range of people with disabilities,        wide variety of assistive technologies.
      ...
      >
        ...
        <div>
          <h4>
            Example 2: A layout table that separates a meaningful sequence when
            linearized
          </h4>
          <p>
            ...
            with the content describing the image, screen readers cannot present
            the content in a meaningful sequence corresponding to the sequence
            presented visually.
          </p>
      ...
      >
        <p>
          The following example demonstrates how CSS has been improperly used to
          create a set of columns. In addition, the text appears visually in the
        ...
        <p>
          ...
          columns. Elements of class "menu1" (Products) and "menu2" (Locations)
          appear as column headings. "Telephones, Computers, and Portable MP3
          Players" are listed under Products and "Idaho" and "Wisconsin" are
          listed under Locations (note the different order for Idaho and
          Wisconsin in the source code order).
        </p>
        <p>
