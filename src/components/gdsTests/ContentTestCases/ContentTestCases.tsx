...
export const ContentTestCases = () => {
  return (
    <>
      <h2>Content</h2>
      <TestCase
        testCaseTitle={"Content identified by location"}
        testCaseNumber={1}
      ...
      {/*What is the problem in the following testCase?*/}
      <TestCase
        testCaseTitle={"Plain language is not used"}
        testCaseNumber={2}
        testCategory={"content"}
      >
        ...
        with HIV infection, and treatments that prolong life and prevent serious
        deterioration of health. Up to 10 percent of the funds for this program
        can be used to support Special Projects of National Significance.
      </TestCase>
      <TestCase
        testCaseTitle={"Content is not in correct reading order in source code"}
        testCaseNumber={3}
        testCategory={"content"}
      >
      ...
      <TestCase
        testCaseTitle={"First instance of abbreviation not expanded"}
        testCaseNumber={5}
        testCategory={"content"}
      >
