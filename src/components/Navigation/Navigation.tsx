              ...
              <li>
                ...
                <ul>
                  <li>
                    <Link
                      className="nav__link"
                      to={"/wcag/perceivable/adaptable/info-and-relationships"}
                    >
                  ...
                  <li>
                    <Link
                      className="nav__link"
                      to={"/wcag/perceivable/adaptable/sensory-characteristics"}
                    >
                  ...
                  <li>
                    <Link
                      className="nav__link"
                      to={"/wcag/perceivable/adaptable/identify-input-purpose"}
                    >
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      className={"nav__link"}
                      to={"/wcag/perceivable/distinguishable/contrast-minimum"}
                    >
                      Contrast (Minimum)
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      className={"nav__link"}
                      to={"/wcag/perceivable/distinguishable/contrast-enhanced"}
                    >
                      Contrast (Enhanced)
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      className={"nav__link"}
                      to={"/wcag/perceivable/distinguishable/non-text-contrast"}
                    >
                      Non-text Contrast
                    </Link>
                  </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      className={"nav__link"}
                      to={"/wcag/operable/keyboard-accessible/no-keyboard-trap"}
                    >
                      No Keyboard Trap
                    </Link>
                  </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    <Link
                      className={"nav__link"}
                      to={"/wcag/understandable/predictable/change-on-request"}
                    >
                      Change on Request
                    </Link>
                  </li>
